      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {products.map((product, idx) => (
            <div
              key={idx}
              className="relative group overflow-hidden rounded-lg shadow-md border border-[var(--stroke)]"
            >
              <img
                src={product.image}
                alt={product.title}
              ...
              />
              <div className="absolute inset-0 bg-[color:var(--overlay-strong)] opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center text-center text-[color:var(--primary-contrast)]">
